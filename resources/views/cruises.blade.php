...
@section('content')
    <div class="cruises-container ">
        <div class="booking-container" style=" top: 100px">
            ...
            <form action="{{ route('cruise.search') }}" method="GET" class="modals">
                ...
                <button type="submit" class="btnmodal btnsubmit">Найти круиз<i class="fa-solid fa-check"
            ...
            @else
                @foreach ($cruises as $cruise)
                    <div class="plan-card @if ($cruise->hit == 1) hit @endif @if ($cruise->sale !== 0) sale @endif">
                        ...
                        <div class="plan-price">
                            <span>
                                ...
                                <span style="font-size: 15px;text-decoration: line-through; text-decoration-thickness: 1px; text-decoration-color: yellow;">
                                    {{ $cruise->price }}$</span> {{ $cruise->price - $cruise->price / 100 * $cruise->sale}}$
                                @endif
                            </span>
                        </div>
                        @if ($cruise->sale !== 0)
                        ...
                        <div class="card-body">
                            <h5 class="card-title plan-title"><a href="{{ route('show', ['slug' => $cruise->slug]) }}"
